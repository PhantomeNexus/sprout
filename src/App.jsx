  ...
  function addPlant(e) {
    ...
    setPlants(prev => [
      ...prev,
      {
        id: Date.now(),
        name: formName.trim(),
        species: formSpecies.trim() || 'Unknown species',
        frequencyDays: freq,
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800">
      ...
      <header className="bg-white border-b border-stone-200 py-8 text-center">
        ...
        <p className="text-stone-500 mt-1 text-lg">Keep your plants alive.</p>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
          ...
          <p className="text-stone-600 text-lg">
            {thirstyCount === 0
              ...
              : thirstyCount === 1
                ...
                : `${thirstyCount} plants need water today.`}
          </p>
          <button
            type="button"
        ...
        {showForm && (
          <div className="bg-white rounded-2xl shadow-sm border border-stone-200 p-6 mb-8">
            <h2 className="text-xl font-semibold text-stone-800 mb-4">Add a new plant</h2>
            ...
            return (
              ...
              >
                ...
                <p className="text-sm text-stone-600">
                  {days === 0 ? 'Last watered today' : days === 1 ? 'Last watered 1 day ago' : `Last watered ${days} days ago`}
                </p>
      ...
      <footer className="text-center py-6 text-sm text-stone-400 border-t border-stone-200 mt-12">
        &copy; 2026 Sprout. Made for forgetful plant parents.
      </footer>
    </div>
  )
}
